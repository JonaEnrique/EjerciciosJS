...
const Alumno = crearClaseAlumno(); // Crear clases mediante una funcion
const alumno = new Alumno("Lionel", "Messi", 1, [{nombre: 'Ron', apellido: 'Weasley', cohorte: 1}], []);

alumno.addAmigos("Jonathan", "Enrique");
alumno.addNota(10);
console.log(alumno.obtenerAmigos());
console.log(alumno.obtenerNotas());
